      ...
      <nav className="fixed top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-6">
            <Link to="/assets" className="text-xs font-black text-[#64748B] hover:text-accent uppercase tracking-widest transition-colors">Browse</Link>
            {isAuthenticated ? (
              <Link to="/app">
              ...
              <>
                <Link to="/login" className="text-xs font-black text-[#64748B] hover:text-accent uppercase tracking-widest transition-colors">Login</Link>
                <Link to="/register">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            >
              <span className="inline-flex items-center rounded-full bg-accent-muted px-3 py-1 text-[11px] font-black uppercase tracking-[0.2em] text-accent ring-1 ring-inset ring-accent/15 mb-8">
                Your No.1 Asset Management Solution
              </span>
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full -z-0 pointer-events-none opacity-40">
          <div className="absolute top-20 left-10 w-72 h-72 bg-accent/25 rounded-full blur-3xl" />
      ...
      <section className="py-32 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="relative p-10 rounded-2xl bg-[#F4F7FA] hover:shadow-2xl hover:shadow-accent/10 transition-all duration-500 group border border-transparent hover:border-accent/25">
              <div className="bg-white w-14 h-14 rounded-2xl flex items-center justify-center mb-10 text-accent shadow-sm transform group-hover:-translate-y-2 transition-transform duration-500">
